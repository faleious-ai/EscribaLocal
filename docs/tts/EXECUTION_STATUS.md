...
| T8.5 | #39 | QA PT-BR com amostras reais | blocked | runner reproduzível, cinco WAVs reais, manifesto estrutural e round-trip auxiliar registrados em `docs/tts/T8.5_QA_REPORT.md`. | **Bloqueio humano:** falta escuta e notas de naturalidade, prosódia, pronúncia e artefatos no manifesto local. | T8.4 |
